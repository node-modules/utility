...
test('md5() should return md5 string', t => {
  ...
  t.is(utils.md5(new Buffer('')), 'd41d8cd98f00b204e9800998ecf8427e');
  t.is(utils.md5(new Buffer('')), utils.md5(''));
  t.is(utils.md5('苏千'), '5f733c47c58a077d61257102b2d44481');
  t.is(utils.md5(new Buffer('苏千')), '5f733c47c58a077d61257102b2d44481');
...
test('sha1() should return sha1 string', t => {
  ...
  t.is(utils.sha1(new Buffer('')), 'da39a3ee5e6b4b0d3255bfef95601890afd80709');
  t.is(utils.sha1(new Buffer('')), utils.sha1(''));
  t.is(utils.sha1('苏千'), '0a4aff6bab634b9c2f99b71f25e976921fcde5a5');
  t.is(utils.sha1(new Buffer('苏千')), '0a4aff6bab634b9c2f99b71f25e976921fcde5a5');
...
test('sha256() should return sha256 hex string', t => {
  ...
  t.is(utils.sha256(new Buffer('')), 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855');
  t.is(utils.sha256(new Buffer('123')), 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3');
  t.is(utils.sha256(new Buffer('哈哈中文')), '0f9d15321510b57fc25b712de846c59cc541de89d47fcd06f6bfe1cd5ff2d7e3');
  t.is(utils.sha256(new Buffer('@Python发烧友')), '80ddd84d1453c994af764bf558c4b96adaced9dd8d7d2194705fe58e1b3162df');
  t.is(utils.sha256(new Buffer('苏千')), '75dd03e3fcdbba7d5bec07900bae740cc8e361d77e7df8949de421d3df5d3635');
});
...
test('hmac() should return hmac-sha1', t => {
  ...
  t.is(utils.hmac('sha1', 'I am a key', '中文，你好'), utils.hmac('sha1', 'I am a key', new Buffer('中文，你好')));
});
